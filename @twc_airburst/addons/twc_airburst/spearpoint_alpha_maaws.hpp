class sp_l14a1_carlGustav: Launcher_Base_F
{
	class WeaponSlotsInfo;
};

class TWC_Weapon_Spearpoint_MAAWS: sp_l14a1_carlGustav
{
	displayname = "L14A1 Spearpoint Alpha (Airburst Config)";
	magazines[] = {
...
class sp_l14a1_carlGustav_no78: Launcher_Base_F
{
	class WeaponSlotsInfo;
};

class TWC_Weapon_Spearpoint_No78_MAAWS: sp_l14a1_carlGustav_no78
{
	displayname = "L14A1 Spearpoint Alpha No78 Scope (Airburst Config)";
	magazines[] = {
		"TWC_Magazine_L14A1_HEAT","TWC_Magazine_L14A1_HE","TWC_Magazine_L14A1_Smoke","TWC_Magazine_L14A1_Illum",
		"TWC_Magazine_L14A1_HE_200", "TWC_Magazine_L14A1_Illum_200",
		"TWC_Magazine_L14A1_HE_300", "TWC_Magazine_L14A1_Illum_300",
